import { getAnalyticsPeriodIntervals } from "../../lib/period"
...
export function availableIntervalsForPeriod(period: string): string[] {
  return [...getAnalyticsPeriodIntervals(period)]
}
