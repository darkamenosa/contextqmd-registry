...
# docker build -t contextqmd_registry .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name contextqmd_registry contextqmd_registry
...
RUN gem install bundler -v 4.0.6 -N
