...
class Analytics::TrackerSnippetTest < ActiveSupport::TestCase
  ...
  test "build returns a copy-paste snippet for the current analytics service origin" do
    ...
    assert_equal "https://analytics.example.test/a/t.js", payload.fetch(:script_url)
    ...
    assert_includes payload.fetch(:snippet_html), %(src="https://analytics.example.test/a/t.js")
